...
var Ship = function(){
  ...
  var hull_block1 = new THREE.BoxGeometry( 10, 5, 5 );
  var hull_block2 = new THREE.BoxGeometry( 15, 10, 1 );
  //hull_block2.center(10,5,5);

  var strut5 = new THREE.BoxGeometry(5, 0.5, 0.5);
  var strut10 = new THREE.BoxGeometry(10, 0.5, 0.5);
  ...
  var hull = union(
    ...
    strut10.clone().translate(0, -2.5-0.25, 2.5-0.25),
    strut10.clone().translate(0, -2.5-0.25, -2.5-0.25),
    strut5.clone().translate((dim.l1-0.5)/2, 0,  (dim.w1-0.5)/2).rotateZ(f.rads(90)),
    strut5.clone().translate((dim.l1-0.5)/2, 0, -(dim.w1-0.5)/2).rotateZ(f.rads(90)),
    strut5.clone().translate((dim.l1-0.5)/2,  (dim.w1-0.5)/2, 0).rotateY(f.rads(90)),
    strut5.clone().translate((dim.l1-0.5)/2, -(dim.w1-0.5)/2, 0).rotateY(f.rads(90))
  );
